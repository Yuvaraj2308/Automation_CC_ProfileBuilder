...
//enter emailID
WebUI.setText(findTestObject('Login_Pages/Sign_In_Page/input_Username'), email)

//enter password
WebUI.setText(findTestObject('Login_Pages/Sign_In_Page/input_Password'), password)
