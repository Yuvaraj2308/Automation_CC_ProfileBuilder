...
//WebUI.setText(findTestObject('Login_Pages/Sign_Up_Page/Input_Username'), 'ppalak2@gmail.com')
...
//select role
WebUI.click(findTestObject('Login_Pages/Sign_Up_Page/button_role_Family'))
