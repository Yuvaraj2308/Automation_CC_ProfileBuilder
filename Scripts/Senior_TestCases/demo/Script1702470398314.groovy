...
//enter emailID
WebUI.setText(findTestObject('Login_Pages/Sign_Up_Page/Input_Username'), 'luffy.pg1730@gmail.com')
...
WebUI.selectOptionByValue(findTestObject('New Folder/Page_CaringConnections-v-1.15/Select_Available_From'), '01:00 PM', 
    false)

WebUI.selectOptionByValue(findTestObject('New Folder/Page_CaringConnections-v-1.15/Select_Available_To'), '03:00 PM', false)
